...
public interface IntegerQuerySortingModel<T> extends QueryModel<T>, QuerySortingModel<T>, OptionalQueryModel<T>, EqualityQueryModel<T, Integer>, NotEqualQueryModel<T, Integer>, IsInQueryModel<T, Integer>, IsNotInQueryModel<T, Integer>, InequalityQueryModel<T, Integer> {
    @Override
