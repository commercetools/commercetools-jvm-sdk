...
import io.sphere.sdk.producttypes.ProductTypeDraftImpl;
...
/**
 ...
 <li class=change-in-release>{@link ProductTypeDraftImpl#of(String, String, List)} has been deprecated in favor of {@link ProductTypeDraftImpl#of(String, String, String, List)} since it is a very good practice to create a {@link ProductType} with a key.</li>
 ...
 <li>Incompatible change: {@link ProductTypeDraftImpl} has now only
 factory methods with an explicit parameter for the attribute declarations to prevent to use
 the getter {@link ProductTypeDraftImpl#getAttributes()} and list add operations. </li>
