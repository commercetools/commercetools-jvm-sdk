...
/** Aggregated counts for a date range facet, returned as a part of {@link de.commercetools.sphere.client.model.SearchResult}. */
@Immutable
public class DateRangeFacetResult implements FacetResult {
    ...
    public static DateRangeFacetResult fromMilliseconds(RangeFacetResult facetResult) {
