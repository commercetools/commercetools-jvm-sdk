...
public class ProductProjectionSearchTest {
    ...
    public void canAccessProductName() throws Exception {
        assertThat(MODEL.name().locale(ENGLISH).facet().allTerms().toSphereFacet()).isEqualTo("name.en");
    ...
    public void canAccessCreatedAt() throws Exception {
        assertThat(MODEL.createdAt().facet().allTerms().toSphereFacet()).isEqualTo("createdAt");
    ...
    public void canAccessLastModifiedAt() throws Exception {
        assertThat(MODEL.lastModifiedAt().facet().allTerms().toSphereFacet()).isEqualTo("lastModifiedAt");
    ...
    public void canAccessCategories() throws Exception {
        assertThat(MODEL.categories().facet().allTerms().toSphereFacet()).isEqualTo("categories.id");
    ...
    public void canAccessPriceAmount() throws Exception {
        assertThat(MODEL.variants().price().amount().facet().allTerms().toSphereFacet()).isEqualTo("variants.price.centAmount");
    ...
    public void canAccessPriceCurrency() throws Exception {
        assertThat(MODEL.variants().price().currency().facet().allTerms().toSphereFacet()).isEqualTo("variants.price.currencyCode");
    ...
    public void canAccessTextCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofText(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.brand");
    ...
    public void canAccessLocTextCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofLocalizableText(attrName).locale(ENGLISH).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.material.en");
    ...
    public void canAccessBooleanCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofBoolean(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.isHandmade");
    ...
    public void canAccessNumberCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofNumber(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.length");
    ...
    public void canCreateDateAttributeExpressions() throws Exception {
        ...
        assertThat(attributeModel().ofDate(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.expirationDate");
    ...
    public void canCreateTimeAttributeExpressions() throws Exception {
        ...
        assertThat(attributeModel().ofTime(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.deliveryHours");
    ...
    public void canCreateDateTimeAttributeExpressions() throws Exception {
        ...
        assertThat(attributeModel().ofDateTime(attrName).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.createdDate");
    ...
    public void canAccessEnumKeyCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofEnum(attrName).key().facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.originCountry.key");
    ...
    public void canAccessMoneyAmountCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofMoney(attrName).amount().facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.originalPrice.centAmount");
    ...
    public void canAccessCurrencyCustomAttributes() throws Exception {
        final String attrName = "originalPrice";
        assertThat(attributeModel().ofMoney(attrName).currency().facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.originalPrice.currencyCode");
    ...
    public void canAccessReferenceCustomAttributes() throws Exception {
        ...
        assertThat(referenceModel.facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.recommendedProduct.id");
    ...
    public void canAccessEnumLabelCustomAttributes() throws Exception {
        final String attrName = "originCountry";
        assertThat(attributeModel().ofEnum(attrName).label().facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.originCountry.label");
    ...
    public void canAccessLocEnumKeyCustomAttributes() throws Exception {
        ...
        assertThat(attributeModel().ofLocalizableEnum(attrName).key().facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.color.key");
    ...
    public void canAccessLocEnumLabelCustomAttributes() throws Exception {
        final String attrName = "color";
        assertThat(attributeModel().ofLocalizableEnum(attrName).label().locale(ENGLISH).facet().allTerms().toSphereFacet()).isEqualTo("variants.attributes.color.label.en");
