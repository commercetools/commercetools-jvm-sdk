...
public class RemoveVariant extends StageableProductUpdateAction {
    ...
    private RemoveVariant(final long id, final ProductUpdateScope productUpdateScope) {
    ...
    public static RemoveVariant of(final long id, final ProductUpdateScope productUpdateScope) {
