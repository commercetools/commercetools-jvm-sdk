...
public class ShippingMethodUpdateCommand extends UpdateCommandDslImpl<ShippingMethod> {
    private ShippingMethodUpdateCommand(final Versioned<ShippingMethod> versioned, final List<UpdateAction<ShippingMethod>> updateActions) {
    ...
    public static ShippingMethodUpdateCommand of(final Versioned<ShippingMethod> versioned,
                                                 final List<UpdateAction<ShippingMethod>> updateActions) {
