 ...
 *
 */
public abstract class MetaModelByIdDeleteCommandImpl<T extends ResourceView<T>, C, E> extends CommandImpl<T> implements ByIdDeleteCommand<T>, MetaModelExpansionDslExpansionModelRead<T, C, E> {
