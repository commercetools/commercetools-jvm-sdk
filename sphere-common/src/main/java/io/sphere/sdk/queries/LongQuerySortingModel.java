...
public interface LongQuerySortingModel<T> extends QueryModel<T>, QuerySortingModel<T>, OptionalQueryModel<T>, EqualityQueryModel<T, Long>, NotEqualQueryModel<T, Long>, IsInQueryModel<T, Long>, IsNotInQueryModel<T, Long>, InequalityQueryModel<T, Long> {
    @Override
