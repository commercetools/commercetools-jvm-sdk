 ...
 */
abstract class RangeTermFacetAndFilterBaseSearchModel<T, V extends Comparable<? super V>> extends TermFacetAndFilterBaseSearchModel<T, V> {
    private final RangeFacetExpression<T> facetExpression;
    private final RangeTermFilterSearchModel<T, V> filterSearchModel;

    RangeTermFacetAndFilterBaseSearchModel(final SearchModel<T> searchModel, final Function<V, String> typeSerializer) {
        super(searchModel, typeSerializer);
        this.facetExpression = new RangeTermFacetSearchModel<>(searchModel, typeSerializer).allRanges();
        this.filterSearchModel = new RangeTermFilterSearchModel<>(searchModel, typeSerializer);
    }
