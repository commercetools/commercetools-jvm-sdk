...
public class EnumFilterSearchModel<T> extends SearchModelImpl<T> {

    public EnumFilterSearchModel(@Nullable final SearchModel<T> parent, @Nullable final String pathSegment) {
