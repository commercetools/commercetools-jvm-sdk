...
public class DateTimeSearchModel<T, S extends DirectionlessSearchSortModel<T>> extends SortableRangeTermModel<T, S, ZonedDateTime> implements SearchSortModel<T, S> {
