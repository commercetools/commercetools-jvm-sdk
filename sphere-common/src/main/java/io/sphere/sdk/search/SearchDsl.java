...
public interface SearchDsl<T, C extends SearchDsl<T, C>> extends ResourceSearch<T> {
     ...
     * @param text the new search text with locale, the locale should be enabled for search (see the project settings in the Merchant Center)
    ...
    /**
     * Returns a new object with the new text as search text.
     * @param locale the new locale, the locale should be enabled for search (see the project settings in the Merchant Center)
