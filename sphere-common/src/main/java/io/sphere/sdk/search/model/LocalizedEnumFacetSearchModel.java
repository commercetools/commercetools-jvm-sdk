...
public class LocalizedEnumFacetSearchModel<T> extends SearchModelImpl<T> {

    public LocalizedEnumFacetSearchModel(@Nullable final SearchModel<T> parent, @Nullable final String pathSegment) {
