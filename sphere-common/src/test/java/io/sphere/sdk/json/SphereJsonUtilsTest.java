...
public class SphereJsonUtilsTest {
    ...
    public void serializeZonedDateTime() throws Exception {
        ...
        final String actual = SphereJsonUtils.toJson(dateTime);
    ...
    public void deserializeZonedDateTime() throws Exception {
        ...
        final ZonedDateTime actual = SphereJsonUtils.readObject(TypeReferences.ZonedDateTimeTypeReference(), ("\"" + timeAsString + "\"").getBytes());
