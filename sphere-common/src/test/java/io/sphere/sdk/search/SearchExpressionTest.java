...
public class SearchExpressionTest {
    ...
    public void buildsTermFacetExpression() throws Exception {
        final TermFacetExpression<Object, String> expression = new TermFacetExpression<>(model(), ofText(), Optional.empty());
    ...
    public void buildsTermFacetExpressionWithAlias() throws Exception {
        final TermFacetExpression<Object, String> expression = new TermFacetExpression<>(model(), ofText(), Optional.of("my-facet"));
    ...
    public void buildsFilteredFacetExpression() throws Exception {
        List<String> terms = asList("foo", "bar");
        final FilteredFacetExpression<Object, String> expression = new FilteredFacetExpression<>(model(), ofText(), terms, Optional.empty());
    ...
    public void buildsFilteredFacetExpressionWithAlias() throws Exception {
        List<String> terms = asList("foo", "bar");
        final FilteredFacetExpression<Object, String> expression = new FilteredFacetExpression<>(model(), ofText(), terms, Optional.of("my-facet"));
    ...
    public void buildsRangeFacetExpression() throws Exception {
        ...
        final RangeFacetExpression<Object, BigDecimal> expression = new RangeFacetExpression<>(model(), ofNumber(), ranges, Optional.empty());
    ...
    public void buildsRangeFacetExpressionWithAlias() throws Exception {
        List<FacetRange<BigDecimal>> ranges = asList(FacetRange.lessThan(valueOf(5)), FacetRange.atLeast(valueOf(3)), FacetRange.of(valueOf(5), valueOf(10)));
        final RangeFacetExpression<Object, BigDecimal> expression = new RangeFacetExpression<>(model(), ofNumber(), ranges, Optional.of("my-facet"));
