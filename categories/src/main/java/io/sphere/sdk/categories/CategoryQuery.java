...
public class CategoryQuery extends EntityQueryWithCopyImpl<Category, CategoryImpl, CategoryQueryModel> {

    public CategoryQuery() {
        super(CategoryRequestDefaults.ENDPOINT, CategoryRequestDefaults.PAGED_QUERY_RESULT_TYPE_REFERENCE);
    }

    public EntityQueryWithCopy<Category, CategoryImpl, CategoryQueryModel> bySlug(final Locale locale, final String slug) {
