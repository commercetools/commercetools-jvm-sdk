...
public class RetrySphereClientTest {
    ...
    public void retryDelete() throws InterruptedException {
        ...
        final Category result = blockingWait(retryClient.execute(CategoryDeleteCommand.of(Versioned.of("some-id", 5L))), 300, TimeUnit.MILLISECONDS);//thread pool needs warm-up
