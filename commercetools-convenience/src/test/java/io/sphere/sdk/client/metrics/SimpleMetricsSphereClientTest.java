...
public class SimpleMetricsSphereClientTest {
    ...
    public void demo() {
        ...
        assertThat(Logger.getAndClear()).matches("observed: ObservedSerializationDuration\\[requestId=1,durationInMilliseconds=\\d+,request=ProjectGet\\[\\]\\]\n" +
                ...
                "observed: ObservedTotalDuration\\[correlationId=ID-123456,successResult=ProjectImpl\\[key=<null>,name=<null>,countries=<null>,languages=<null>,currencies=<null>,createdAt=<null>,trialUntil=<null>\\],errorResult=<null>,requestId=1,durationInMilliseconds=\\d+,request=ProjectGet\\[\\]\\]");
    }
