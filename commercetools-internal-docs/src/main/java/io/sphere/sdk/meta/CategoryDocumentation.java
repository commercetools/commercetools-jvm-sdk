...
/**
 ...
 <pre><code>{@include.file commercetools-convenience/src/it/resources/category-tree-1.txt}</code></pre>
 ...
 <pre><code>{@include.file commercetools-convenience/src/it/resources/category-import-1.csv}</code></pre>
