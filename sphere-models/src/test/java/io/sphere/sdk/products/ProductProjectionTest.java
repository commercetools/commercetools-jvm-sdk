...
public class ProductProjectionTest {
    ...
    public void deserialization() throws Exception {
        ...
        final PagedSearchResult<ProductProjection> pagedSearchResult = SphereJsonUtils.readObject(jsonString, new TypeReference<PagedSearchResult<ProductProjection>>() {
        });
    }
    ...
    @Test
    public void findMatchingVariants() throws Exception {
    ...
    @Test
    public void findFirstMatchingVariant() throws Exception {
        final ProductProjection product = getProductProjectionFromSearch();
