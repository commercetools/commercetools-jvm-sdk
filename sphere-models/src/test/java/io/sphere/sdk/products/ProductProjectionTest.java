...
public class ProductProjectionTest {
    ...
    public void deserialization() throws Exception {
        ...
        final PagedSearchResult<ProductProjection> pagedSearchResult = SphereJsonUtils.readObjectFromJsonString(new TypeReference<PagedSearchResult<ProductProjection>>() {
        }, jsonString);
    }
}