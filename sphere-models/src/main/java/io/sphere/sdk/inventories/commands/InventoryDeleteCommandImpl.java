...
public class InventoryDeleteCommandImpl extends ByIdDeleteCommandImpl<InventoryEntry> {
    private InventoryDeleteCommandImpl(final Versioned<InventoryEntry> versioned) {
    ...
    public static DeleteCommand<InventoryEntry> of(final Versioned<InventoryEntry> versioned) {
        return new InventoryDeleteCommandImpl(versioned);
    }
}
