...
public class CustomObjectQueryImpl<T> extends UltraQueryDslImpl<CustomObject<T>, CustomObjectQuery<T>, CustomObjectQueryModel<CustomObject<T>>, Void> implements CustomObjectQuery<T> {
