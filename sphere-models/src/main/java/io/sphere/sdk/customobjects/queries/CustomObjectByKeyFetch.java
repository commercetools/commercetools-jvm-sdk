...
public interface CustomObjectByKeyFetch<T> extends MetaModelFetchDsl<CustomObject<T>, CustomObject<T>, CustomObjectByKeyFetch<T>, CustomObjectExpansionModel<CustomObject<T>>> {
    ...
    @Override
    CustomObjectByKeyFetch<T> plusExpansionPaths(final Function<CustomObjectExpansionModel<CustomObject<T>>, ExpansionPath<CustomObject<T>>> m);

    @Override
    CustomObjectByKeyFetch<T> withExpansionPaths(final Function<CustomObjectExpansionModel<CustomObject<T>>, ExpansionPath<CustomObject<T>>> m);
