 ...
 *  {@doc.gen intro}
 *
 * {@include.example io.sphere.sdk.categories.commands.CategoryUpdateCommandTest#setDescription()}
 */
public class SetDescription extends UpdateActionImpl<Category> {
    @Nullable
