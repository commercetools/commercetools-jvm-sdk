...
public class ProductProjectionSearchModelFacetedSearchIntegrationTest extends ProductProjectionSearchModelIntegrationTest {
    ...
    public void facetedSearchOnBooleanAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofBoolean(ATTR_NAME_BOOLEAN).facetedSearch().by(BOOL_TRUE),
    ...
    public void facetedSearchOnTextAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofString(ATTR_NAME_TEXT).facetedSearch().by(TEXT_FOO),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnLocTextAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizedString(ATTR_NAME_LOC_TEXT).locale(ENGLISH).facetedSearch().by(LOC_TEXT_FOO.get(ENGLISH)),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnEnumKeyAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofEnum(ATTR_NAME_ENUM).key().facetedSearch().by(ENUM_TWO.getKey()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnEnumLabelAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofEnum(ATTR_NAME_ENUM).label().facetedSearch().by(ENUM_TWO.getLabel()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnLocEnumKeyAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizableEnum(ATTR_NAME_LOC_ENUM).key().facetedSearch().by(LOC_ENUM_TWO.getKey()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnLocEnumLabelAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizableEnum(ATTR_NAME_LOC_ENUM).label().locale(GERMAN).facetedSearch().by(LOC_ENUM_TWO.getLabel().get(GERMAN)),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnNumberAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofNumber(ATTR_NAME_NUMBER).facetedSearch().by(NUMBER_5.toPlainString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
                        TermStats.of("5.0", 1),
                        TermStats.of("10.0", 1)));
    ...
    public void facetedSearchOnNumberRangedAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofNumber(ATTR_NAME_NUMBER).facetedSearch().byRange(atMost(NUMBER_5.toPlainString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
    ...
    public void facetedSearchOnMoneyAmountAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY).centAmount().facetedSearch().by(toCents(MONEY_500_EUR).toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnMoneyAmountRangedAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY).centAmount().facetedSearch().byRange(atMost(toCents(MONEY_500_EUR).toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnMoneyCurrencyAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY).currency().facetedSearch().by(MONEY_500_EUR.getCurrency().getCurrencyCode()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
                        TermStats.of("EUR", 1),
                        TermStats.of("USD", 1)));
    ...
    public void facetedSearchOnDateAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofDate(ATTR_NAME_DATE).facetedSearch().by(DATE_2001.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnDateRangedAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofDate(ATTR_NAME_DATE).facetedSearch().byRange(atMost(DATE_2001.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnTimeAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofTime(ATTR_NAME_TIME).facetedSearch().by(TIME_22H.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnTimeRangedAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofTime(ATTR_NAME_TIME).facetedSearch().byRange(atMost(TIME_22H.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnDateTimeAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofDateTime(ATTR_NAME_DATE_TIME).facetedSearch().by(DATE_TIME_2001_22H.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnDateTimeRangedAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofDateTime(ATTR_NAME_DATE_TIME).facetedSearch().byRange(atMost(DATE_TIME_2001_22H.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnReferenceAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofReference(ATTR_NAME_REF).id().facetedSearch().by(productSomeId.getId()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsOnly(
    ...
    public void facetedSearchOnBooleanSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofBoolean(ATTR_NAME_BOOLEAN_SET).facetedSearch().by(BOOL_FALSE),
                ids -> assertThat(ids).containsOnly(product1.getId()),
    ...
    public void facetedSearchOnTextSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofString(ATTR_NAME_TEXT_SET).facetedSearch().by(TEXT_BAR),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnLocTextSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizedString(ATTR_NAME_LOC_TEXT_SET).locale(ENGLISH).facetedSearch().by(LOC_TEXT_BAR.get(ENGLISH)),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnEnumKeySetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofEnum(ATTR_NAME_ENUM_SET).key().facetedSearch().by(ENUM_THREE.getKey()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnEnumLabelSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofEnum(ATTR_NAME_ENUM_SET).label().facetedSearch().by(ENUM_THREE.getLabel()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnLocEnumKeySetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizableEnum(ATTR_NAME_LOC_ENUM_SET).key().facetedSearch().by(LOC_ENUM_THREE.getKey()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnLocEnumLabelSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofLocalizableEnum(ATTR_NAME_LOC_ENUM_SET).label().locale(GERMAN).facetedSearch().by(LOC_ENUM_THREE.getLabel().get(GERMAN)),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnNumberSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofNumber(ATTR_NAME_NUMBER_SET).facetedSearch().by(NUMBER_10.toPlainString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
                        TermStats.of("5.0", 2),
                        TermStats.of("10.0", 1)));
    ...
    public void facetedSearchOnNumberRangedSetAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofNumber(ATTR_NAME_NUMBER_SET).facetedSearch().byRange(atLeast(NUMBER_10.toPlainString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnMoneyAmountSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY_SET).centAmount().facetedSearch().by(toCents(MONEY_1000_USD).toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnMoneyAmountRangedSetAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY_SET).centAmount().facetedSearch().byRange(atLeast(toCents(MONEY_1000_USD).toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnMoneyCurrencySetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofMoney(ATTR_NAME_MONEY_SET).currency().facetedSearch().by(MONEY_1000_USD.getCurrency().getCurrencyCode()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
                        TermStats.of("EUR", 2),
                        TermStats.of("USD", 1)));
    ...
    public void facetedSearchOnDateSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofDate(ATTR_NAME_DATE_SET).facetedSearch().by(DATE_2002.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnDateRangedSetAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofDate(ATTR_NAME_DATE_SET).facetedSearch().byRange(atLeast(DATE_2002.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnTimeSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofTime(ATTR_NAME_TIME_SET).facetedSearch().by(TIME_23H.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnTimeRangedSetAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofTime(ATTR_NAME_TIME_SET).facetedSearch().byRange(atLeast(TIME_23H.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnDateTimeSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofDateTime(ATTR_NAME_DATE_TIME_SET).facetedSearch().by(DATE_TIME_2002_23H.toString()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
    ...
    public void facetedSearchOnDateTimeRangedSetAttributes() throws Exception {
        testResultWithRange(model().allVariants().attribute().ofDateTime(ATTR_NAME_DATE_TIME_SET).facetedSearch().byRange(atLeast(DATE_TIME_2002_23H.toString())),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                rangeStats -> {
                    assertThat(rangeStats.getLowerEndpoint()).isEqualTo("0.0");
                    assertThat(rangeStats.getUpperEndpoint()).isEqualTo(null);
    ...
    public void facetedSearchOnReferenceSetAttributes() throws Exception {
        testResultWithTerms(model().allVariants().attribute().ofReference(ATTR_NAME_REF_SET).id().facetedSearch().by(productOtherId.getId()),
                ids -> assertThat(ids).containsOnly(product1.getId()),
                termStats -> assertThat(termStats).containsExactly(
