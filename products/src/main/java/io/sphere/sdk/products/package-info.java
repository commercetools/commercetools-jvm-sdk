 ...
 *
 * Products can be created in the backend by executing a {@link io.sphere.sdk.products.ProductCreateCommand}:
 *
 * {@include.example example.CreateProductExamples#createWithClient()}
 *
 * {@link io.sphere.sdk.products.ProductCreateCommand} requires one instance of {@link io.sphere.sdk.products.NewProduct}
