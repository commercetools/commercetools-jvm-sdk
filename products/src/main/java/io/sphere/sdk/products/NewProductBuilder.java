...
public final class NewProductBuilder extends ProductDataNewProductBuilderBase<NewProductBuilder> implements Builder<NewProduct> {
    ...
    private NewProductBuilder(final Reference<ProductType> productType, LocalizedStrings name, LocalizedStrings slug, final NewProductVariant masterVariant) {
        super(name, slug);
        this.productType = productType;
        this.masterVariant = masterVariant;
    }

    public static NewProductBuilder of(final Referenceable<ProductType> productType, LocalizedStrings name, LocalizedStrings slug, final NewProductVariant masterVariant) {
