...
public final class CartDiscountDraftBuilder extends CartDiscountDraftBuilderBase<CartDiscountDraftBuilder> {
    ...
    CartDiscountDraftBuilder(final @Nullable Boolean active, final String cartPredicate, final @Nullable CustomFieldsDraft custom, final @Nullable LocalizedString description,
                             final @Nullable String key, final LocalizedString name, final Boolean requiresDiscountCode, final String sortOrder, final StackingMode stackingMode, final @Nullable CartDiscountTarget target,
