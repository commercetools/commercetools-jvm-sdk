...
@JsonTypeName(CategorySlugChangedMessage.MESSAGE_TYPE)
public final class CategorySlugChangedMessage extends GenericMessageImpl<Category> {
    ...
    @JsonCreator
    private CategorySlugChangedMessage(final String id, final Long version, final ZonedDateTime createdAt, final ZonedDateTime lastModifiedAt, final JsonNode resource, final Long sequenceNumber, final Long resourceVersion, final String type, final LocalizedString slug) {
