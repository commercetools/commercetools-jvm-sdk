...
public final class ParcelTrackingDataUpdatedMessage extends GenericMessageImpl<Order> {
    ...
    @JsonCreator
    private ParcelTrackingDataUpdatedMessage(final String id, final Long version, final ZonedDateTime createdAt, final ZonedDateTime lastModifiedAt, final JsonNode resource, final Long sequenceNumber, final Long resourceVersion, final String type,
