 ...
 * register an according {@link MonetaryConversionsSingletonSpi} that manages the
 ...
 * to the registered {@link MonetaryConversionsSingletonSpi} SPI, which also is required
 * to be thread-safe.
 *
